...
addon.conditions.CreateCondition = function(trigger)
	...
	aura.ChangeInverse = function(self, ...)
		local change = addon.conditions.ChangeInverse(...)
		table.insert(self.changes, change)
	end
	...
	aura.CheckUnitCount = function(self, ...)
		self.check = addon.conditions.CheckUnitCount(...)
	end
