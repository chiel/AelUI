...
ns.weakauras.classes.monk = {
	...
	spells = {
		chiBurst = spellIcon(123986),
		chiWave = spellIcon(115098),
		...
		summonBlackOxStatue = spellIcon(115315),
		summonJadeSerpentStatue = spellIcon(115313),
		summonWhiteTigerStatue = spellIcon(388686),
